...
### Changed
- **Improved Package Metadata**: Enhanced crates.io description and added comprehensive metadata
  - More descriptive package description highlighting key features
  - Added keywords and categories for better discoverability
  - Updated homepage, documentation, and repository links

### Documentation
- **README Improvements**: Reorganized and enhanced user documentation
  - Added status badges (CI, crates.io version, downloads, license, Rust version)
  - Promoted `cargo install noet` as primary installation method
  - Collapsed OS-specific installation instructions into details sections for cleaner layout
  - Updated feature list to include rate limiting and Japanese UI
...
[0.1.2]: https://github.com/kako-jun/noet/compare/v0.1.1...v0.1.2
