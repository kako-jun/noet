...
# This file overrides global settings (~/.config/noet/config.toml) for this workspace
# Workspace-specific settings take precedence over global settings

# Default article status (draft or published)
# default_status = "draft"

# Default tags for articles
# default_tags = ["workspace-tag", "project-tag"]

# Editor command (e.g., "code -w", "vim", "emacs")
# editor = "code -w"

# Username for this workspace
# username = "your-workspace-username"

# Base URL (usually no need to change)
